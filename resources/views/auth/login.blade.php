<x-layouts.app :title="$title">
    <div
        ...
        <div class="bg-white shadow-lg rounded-xl p-12 mx-6 max-w-md w-full bg-opacity-[75%]">
            <h1 class="text-center text-gray-800 font-semibold text-xl mb-5">LOGIN</h1>
            <form method="POST" action="{{ route('authenticate') }}" id="login-form">
                ...
                <div class="mb-3 flex items-center">
                    ...
                    <div class="w-full">
                        <input type="email" id="email" name="email" placeholder="Email"
                            class="py-2 placeholder-[#616161] text-gray-800 dark:text-white bg-white text-sm font-medium pl-8 w-full flex items-center border rounded-lg focus:outline-none"
                ...
                <div class="mb-5 flex items-center relative">
                    ...
                    <div class="w-full">
                        <input type="password" id="password" name="password" placeholder="Password"
                            class="pl-8 py-2 placeholder-[#616161] text-gray-800 dark:text-white font-medium text-sm w-full border rounded-lg focus:outline-none"
                            required>
                    </div>
                    <div class="absolute right-0 mr-2 cursor-pointer" id="togglePassword">
                        <svg id="eyeIcon" class="w-5 h-5 text-gray-800 dark:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path
                ...
                @endif
                <button type="submit"
                    class="mt-5 w-full bg-blue-500 text-sm text-white p-2 rounded-lg font-medium hover:bg-blue-600">
                    SIGN IN
                </button>
            </form>
            <div class="text-center mt-4">
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <a href="{{ route('register.form') }}" class="text-blue-600 hover:underline font-medium">
                        Create one now
                    </a>
                </p>
            </div>
