<x-layouts.layout :title="$title" :active="$active">
    <div class="max-w-3xl mx-auto py-6 sm:py-10 px-4 sm:px-6 lg:px-8">
        <h1 class="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Create New Task</h1>
        ...
        <form action="{{ route('tasks.store') }}" method="POST"
            ...
            <div class="mb-4 sm:mb-5">
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}"
                    class="shadow appearance-none border rounded w-full py-2 sm:py-2.5 px-3 text-gray-700 text-sm sm:text-base leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    required>
            </div>
            ...
            <div class="mb-4 sm:mb-5">
                ...
                <textarea id="description" name="description" rows="4"
                    class="shadow appearance-none border rounded w-full py-2 sm:py-2.5 px-3 text-gray-700 text-sm sm:text-base leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none sm:resize-y">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <button type="submit"
                    class="w-full sm:w-auto bg-blue-500 hover:bg-blue-700 text-white font-bold py-2.5 sm:py-2 px-6 sm:px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
                    Create Task
                </button>
            </div>
        </form>
